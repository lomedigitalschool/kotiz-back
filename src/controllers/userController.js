...
  try {
    emitRealtimeUpdate('user_updated', { userId: user.id });
  } catch (e) {
    console.warn('Impossible d\'émettre l\'update temps réel (Socket.IO non initialisé?)', e.message);
  }
  
...
  // 💡 Utilisation de la fonction exportée
  try {
    emitRealtimeUpdate('user_removed', { userId });
  } catch (e) {
    console.warn('Impossible d\'émettre l\'update temps réel (Socket.IO non initialisé?)', e.message);
  }
  
